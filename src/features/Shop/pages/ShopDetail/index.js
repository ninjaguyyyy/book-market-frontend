        ...
        <Row>
          <Col xs={8}>
            <Row>
              ...
              <Col xs={7}>
                <MainInfo book={book} addToFavorite={this.addToFavorite} />
              </Col>
            </Row>
          </Col>
          <Col xs={4}>
            <PayCard handleAddToCart={this.handleAddToCart} book={book} />
          </Col>
        </Row>
        <Row>
          <Col>
            <InfoTab des={book.description} previews={book.previewImgs} />
          </Col>
        </Row>
    ...
    return (
      <div>
        <Container className="container-fluid ShopDetail">
          {_.isEmpty(book) ? this.renderProgress() : this.renderBook(book)}
        </Container>
        <Snackbar
